  ...
  function ShortcutManager() {
    ...
    _this._parseShortcutDescriptor = function (item) {
      if (_lodash2.default.isPlainObject(item)) {
        return _lodash2.default.get(item, _this._platformName);
      }
      return item;
    };
  ...
  _createClass(ShortcutManager, [{
    ...
    value: function getAllShortcutsForPlatform(platformName) {
      var _transformShortcuts = function _transformShortcuts(shortcuts) {
        return _lodash2.default.reduce(shortcuts, function (result, keyValue, keyName) {
          if (_lodash2.default.isPlainObject(keyValue)) {
    ...
    value: function getShortcuts(componentName) {
      ...
      var shortcuts = (0, _lodash2.default)(cursor).map(this._parseShortcutDescriptor).flatten().compact().value();
    ...
    value: function _parseShortcutKeyName(obj, keyName) {
      ...
      var result = _lodash2.default.findKey(obj, function (item) {
        if (_lodash2.default.isPlainObject(item)) {
          item = _lodash2.default.get(item, _this2._platformName);
        }
